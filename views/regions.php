	...
	<div class="container">
		<div class="row">
			<?php foreach($regions as $region): ?>
				<?php if(($region['region_name'] != 'Non définie') & ($region['region_name'] != 'Armagnac') & ($region['region_name'] != 'Bières') & ($region['region_name'] != 'Bouchons') & ($region['region_name'] != 'Calvados') & ($region['region_name'] != 'Cognac') & ($region['region_name'] != 'Cornichons') & ($region['region_name'] != 'Crèmes') & ($region['region_name'] != 'Eaux de Vie') & ($region['region_name'] != 'France') & ($region['region_name'] != 'Gins') & ($region['region_name'] != 'Liqueurs') & ($region['region_name'] != 'Portos') & ($region['region_name'] != 'Rhums') & ($region['region_name'] != 'Tartinables') & ($region['region_name'] != 'Téquilas') & ($region['region_name'] != 'Verrerie') & ($region['region_name'] != 'Vinaigres') & ($region['region_name'] != 'Whiskies') & ($region['region_name'] != 'Vodkas')) : ?>
